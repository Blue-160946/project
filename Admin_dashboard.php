    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                    <div class="overflow-hidden position-relative rounded-3">
                        <a href="stock.php"><img class="img-fluid"
                                src="https://cdn-icons-png.flaticon.com/512/679/679720.png" alt=""></a>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                <div class="team-item">
                    <div class="overflow-hidden position-relative rounded-3">
                        <a href="admin_orders.php"><img class="img-fluid"
                                src="https://www.shutterstock.com/image-vector/shopping-cart-check-mark-icon-600nw-1708233319.jpg" alt=""></a>
                    </div>
                    <div class="text-center border border-5 border-light border-top-0 p-4">
                        <h5 class="mb-0">View All Orders</h5>
                    </div>
                </div>
            </div>
